...
class Musicplugin {
  static const MethodChannel _channel =
      const MethodChannel('musicplugin');
  ...
  Musicplugin setHandlePermissions(bool handlePermissions) {
    _handlePermissions = handlePermissions;
    return this;
  }

  Musicplugin setExecuteAfterPermissionGranted(
  ...
  static Future<dynamic> allSongs() async {
    ...
    List<dynamic> songs = await _channel.invokeMethod('getAllSongs', params);
